...
class GmsGateOutVehiclesScreen extends StatefulWidget {
  final LoginModelApi userData;

  const GmsGateOutVehiclesScreen({Key? key, required this.userData})
      : super(key: key);

  @override
  State<GmsGateOutVehiclesScreen> createState() =>
      _GmsGateOutVehiclesScreenState();
}

class _GmsGateOutVehiclesScreenState extends State<GmsGateOutVehiclesScreen> {
  DateTime? _fromDate;
  DateTime? _toDate;
