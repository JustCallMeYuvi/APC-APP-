...
class MaxkingGMSPage extends StatefulWidget {
  final LoginModelApi userData;
  const MaxkingGMSPage({Key? key, required this.userData}) : super(key: key);

  @override
  _MaxkingGMSPageState createState() => _MaxkingGMSPageState();
}

class _MaxkingGMSPageState extends State<MaxkingGMSPage> {
