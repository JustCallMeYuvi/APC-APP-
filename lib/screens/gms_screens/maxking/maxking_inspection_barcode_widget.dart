...
class MaxkingInspectedBarcodesWidget extends StatefulWidget {
    final Function(String) onBarcodeSelected; // Callback to pass selected barcode
   MaxkingInspectedBarcodesWidget({required this.onBarcodeSelected});
  @override
  _MaxkingInspectedBarcodesWidgetState createState() =>
      _MaxkingInspectedBarcodesWidgetState();
}

class _MaxkingInspectedBarcodesWidgetState extends State<MaxkingInspectedBarcodesWidget> {
  ...
  Future<void> _fetchInspectedBarcodes() async {
    ...
    try {
      ...
      final url = '${ApiHelper.maxkingGMSUrl}getinspectedbarcodes';
