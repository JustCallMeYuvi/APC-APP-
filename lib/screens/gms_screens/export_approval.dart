...
// class ExportApproval extends StatefulWidget {
//   final int vehicleID;

//   const ExportApproval({super.key, required this.vehicleID});

//   @override
//   _ExportApprovalState createState() => _ExportApprovalState();
// }

// class _ExportApprovalState extends State<ExportApproval> {
...
//   Future<VehicleDetailsModel?> fetchVehicleDetails(int vehicleID) async {
//     final uri = Uri.parse('${ApiHelper.gmsUrl}ExportArrovals?id=$vehicleID');
...
//             return VehicleDetailsModel.fromJson(detailsJson[0]);
//           } else {
...
//                   Navigator.of(context).pop();
//                   approveVehicle(
//                       context, widget.vehicleID); // Pass required arguments
//                 },
//               ),
//             ],
//           );
...
//     try {
//       final uri = Uri.parse('${ApiHelper.gmsUrl}Approve?id=$vehicleID');
...
//                         .pop(true); // Close both dialogs/screens
//                   },
//                 ),
//               ],
//             );
...
//     return Scaffold(
//       appBar: AppBar(
//         title: Text("Vehicle Full Details"),
//         centerTitle: true,
...
//                             SizedBox(height: 10),
//                             Text(
//                               "Container Number: ${_vehicle!.containerNumberIN}",
//                               style: TextStyle(fontSize: 18),
//                             ),
//                             SizedBox(height: 10),
//                             Text(
...
//                             SizedBox(height: 10),
//                             Text(
//                               "Arrival Time: ${_vehicle!.arrivalTime}",
//                               style: TextStyle(fontSize: 18),
//                             ),
//                             SizedBox(height: 10),
//                             Text(
...
//                             SizedBox(height: 10),
//                             Text(
//                               "Created By: ${_vehicle!.createdBy}",
//                               style: TextStyle(fontSize: 18),
//                             ),
//                             SizedBox(height: 10),
//                             Text(
//                               "Ship Mode: ${_vehicle!.shipMode}",
//                               style: TextStyle(fontSize: 18),
//                             ),
//                             SizedBox(height: 10),
//                             Text(
//                               "Created Date: ${_vehicle!.createdDate}",
//                               style: TextStyle(fontSize: 18),
//                             ),
//                           ],
//                         ),
...
//       }
//     } else {
//       print('Failed to load vehicle details, status code: ${response.statusCode}');
//       setState(() {
//         _isLoading = false;
//       });
//     }
...
class _ExportApprovalState extends State<ExportApproval> {
  ...
  //     // Ensure that the context is valid before calling showDialog
  //     if (response.statusCode == 200) {
  //       // Check if the widget is still mounted before showing the dialog
  //       if (context.mounted) {
  //         _showDialog(context, "Success", "Vehicle approved successfully");
  //       }
  //     } else {
  //       if (context.mounted) {
  ...
  //       if (context.mounted) {
  //         _showDialog(
  //             context, "Success", "Vehicle approved successfully", true);
  //       }
  //     } else {
  //       if (context.mounted) {
  //         _showDialog(context, "Error",
  //             "Failed to approve the vehicle, please try again!", false);
  //       }
  //     }
  //   } catch (e) {
  //     print('Error approving vehicle: $e');
  ...
  //               if (isSuccess) {
  //                 Navigator.of(context).pop(
  //                     true); // Go back to previous screen or handle accordingly
  //               }
  //             },
  //           ),
  //         ],
  ...
  //       return AlertDialog(
  //         title: Text("Error"),
  //         content: Text("Failed to approve the vehicle, please try again!"),
  //         actions: <Widget>[
  //           TextButton(
  //              child: Text("OK"),
  //              onPressed: () {
