...
class _EmpCountScreenState extends State<EmpCountScreen> {
  ...
  // raw data list from API (years or months)
  List<EmpItem> _empData = [];
  ...
  Future<void> _fetchEmpCount() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        try {
          final EmpCount empCount = empCountFromJson(response.body);
          final List<EmpItem> items = empCount.data;

          // -------------------------
          // CALCULATE TOTAL JOIN / RESIGN
          // -------------------------
          final int joinedSum =
              items.fold(0, (sum, e) => sum + (e.totalJoined));
  ...
  // Small card widget used on the right side
                                    ...
                                    child: Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          // 🌟 SHOW ONLY YEAR WHEN allmonthsofyear
                                          if (_selectedType == "Year Wise") ...[
                                            const Text(
                                              "Selected Year",
                                              style: TextStyle(
                                                fontSize: 15,
                                          ...
                                          // 🌟 SHOW BOTH YEAR + MONTH WHEN monthwise
                                          if (_selectedType ==
                                              "Month Wise") ...[
                                            const Text(
                                              "Selected Year",
