...
//    final String apiUrl =
//         "http://10.3.0.70:9042/api/HR/GetEmpPunchDetails?employeeNumber=${widget.userData.empNo}&startDate=$startDate&endDate=$endDate";
        ...
        setState(() {
          punches = punchDetails.data
              .map((datum) => {
                    ...
                    "cardTime":
                        datum.carDTime.toIso8601String().substring(0, 10),
                    "workOnA": datum.worKOnaTime,
                    "workOffA": datum.worKOffaTime,
                    "workOnB": datum.worKOnbTime,
                    "workOffB": datum.worKOffbTime,
                  })
              .toList();
          isLoading = false;
        });
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        emPNo: json["emP_NO"],
        carDTime: DateTime.parse(json["carD_TIME"]),
        worKOnaTime: json["worK_ONA_TIME"] ?? 'N/A',
        worKOffaTime: json["worK_OFFA_TIME"] ?? 'N/A',
        worKOnbTime: json["worK_ONB_TIME"] ?? 'N/A',
        worKOffbTime: json["worK_OFFB_TIME"] ?? 'N/A',
      );

  Map<String, dynamic> toJson() => {
        "emP_NO": emPNo,
        "carD_TIME": carDTime.toIso8601String(),
        "worK_ONA_TIME": worKOnaTime,
        "worK_OFFA_TIME": worKOffaTime,
        "worK_ONB_TIME": worKOnbTime,
        "worK_OFFB_TIME": worKOffbTime,
