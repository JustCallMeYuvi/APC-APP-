...
GetCarsDetailsModel getCarsDetailsModelFromJson(String str) => GetCarsDetailsModel.fromJson(json.decode(str));

String getCarsDetailsModelToJson(GetCarsDetailsModel data) => json.encode(data.toJson());
