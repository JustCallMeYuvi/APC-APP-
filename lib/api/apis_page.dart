...
//         // _productionUrl = 'http://10.3.0.208:8084/api/Production/';
//         // _carConveynanceUrl = 'http://10.3.0.208:8084/api/Car_Conveyance_/';
//         // _dormitoryURL = 'http://10.3.0.208:8084/api/Dormitory_/';
//         // _mntURL = 'http://10.3.0.208:8084/api/MNT_/';
...
class ApiHelper {
  /// ✅ BASE ROOT
  // static String _baseApi = 'http://10.3.0.70:9042/api/';

  static String _baseApi = 'http://10.3.0.208:8084/api/';

  static String serverStatus = ''; // NEW

  /// ✅ MODULE BASE URLS
  static String get baseUrl => '${_baseApi}HR/';
  static String get gmsUrl => '${_baseApi}GMS/';
  static String get maxkingGMSUrl => '${_baseApi}Maxking_GMS_/';
  static String get productionUrl => '${_baseApi}Production/';
  static String get carConveynanceUrl => '${_baseApi}Car_Conveyance_/';
  static String get dormitoryURL => '${_baseApi}Dormitory_/';
  static String get mntURL => '${_baseApi}MNT_/';
  static String get assetUrl => '${_baseApi}AssetManagement/';
  ...
  static Future<void> updateUrlsBasedOnNetwork() async {
    ...
    if (ipAddress != null &&
      ...
      if (isPrimaryWorking) {
        ...
        _baseApi = primaryUrl;
        serverStatus = '🟢 Primary Server';
      } else {
        print("⚠️ Primary down, switching to BACKUP");
        _baseApi = backupUrl;
        serverStatus = '🟡 Backup Server';
      }
  ...
  static Future<bool> _isServerReachable(String url) async {
    try {
      ...
      final request =
          await HttpClient().getUrl(uri).timeout(const Duration(seconds: 3));
  ...
  // =====================================
  // 🔐 YOUR ALL EXISTING APIs (UNCHANGED)
  // =====================================

  static String login(String username, String password) =>
      '${baseUrl}LoginApi?username=$username&password=$password';

  static String getEmpDetails(String empNo) =>
      '${baseUrl}GetEmpDetails?empNo=$empNo';

  static String getEmpDetailsUserNameBased(String username) =>
      '${baseUrl}GetEmpDetails?empNo=$username';

  static String updatePasswordApi(
      String empNo, String oldPassword, String newPassword) {
    return '${baseUrl}UpdatePassword?empNo=$empNo&oldPassword=$oldPassword&newPassword=$newPassword';
  }

  static String getNotifications(String username) =>
      '${baseUrl}get-notifications/$username';

  static String getUserDetailsApi(String empNo) =>
      '${baseUrl}GetUserDetails?empNo=$empNo';

  static Uri checkUpdateApi(String currentVersion) =>
      Uri.parse('${baseUrl}check-version?clientVersion=$currentVersion');

  static String sendNotificationApi() => '${baseUrl}send-notification';

  static String getWorkTargets(String fromDate, String toDate) =>
      '${baseUrl}GetWorkTargets?fromDate=$fromDate&toDate=$toDate';

  static String getEfficiencyReport(DateTimeRange? dateRange) {
    String url = '${baseUrl}efficiency-report';
    if (dateRange != null) {
      final from = dateRange.start.toIso8601String().substring(0, 10);
      final to = dateRange.end.toIso8601String().substring(0, 10);
  ...
  static String getRftReport(DateTimeRange? dateRange) {
    String url = '${baseUrl}GetProductionData';
    if (dateRange != null) {
      final from = dateRange.start.toIso8601String().substring(0, 10);
      final to = dateRange.end.toIso8601String().substring(0, 10);
  ...
  static String getSeOrderDetailsApi(DateTimeRange? dateRange) {
    String url = '${baseUrl}GetSeOrderDetails';
    if (dateRange != null) {
      final from = dateRange.start.toIso8601String().substring(0, 10);
      final to = dateRange.end.toIso8601String().substring(0, 10);
      url += '?fromDate=$from&toDate=$to';
  ...
  static String notifyApiforLeaveRequest(String role, String plant) =>
      '${baseUrl}Notify?Role=$role&plant=$plant';

  static String getAbsentListApi(String plant) =>
      '${baseUrl}GetAbsentList?Plant=$plant';

  static String getEmployeeListApi() => '${baseUrl}GetEmployeeList';

  static String getPlantsforLeaves() => '${baseUrl}GetPlants';

  static String getProcessTypes() => '${baseUrl}GetProcessType';

  static String getProductionLinesApi(String plant) =>
      '${baseUrl}GetProductionLines?plant=$plant';

  static String getSkillNamesApi(String process) =>
      '${baseUrl}GetSkillNames?processType=$process';

  static String checkDeptApi(String plant, String deptCode) =>
      '${baseUrl}CheckDept?plant=$plant&deptCode=$deptCode';

  static String submitPlantDataApi() => '${baseUrl}SubmitPlantData';

  static String getHeadCountApi(String plant, String dept) =>
      '${baseUrl}GetHeadCount?plant=$plant&departmentCode=$dept';

  static String getApprovedStatusApi(String plant) =>
      '${baseUrl}GetApprovedStatus?plant=$plant';

  static String insertAbsentListApi() => '${baseUrl}InsertAbsentList';

  static String getApproveStatusApi() => '${baseUrl}ApproveStatus';

  static String getVehicleTacking() => '${gmsUrl}status-report';

  static String getMaxkingVehicleTacking() => '${maxkingGMSUrl}status-report';
}
